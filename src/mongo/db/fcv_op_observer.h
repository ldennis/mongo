...
/**
 * OpObserver for Feature Compatibility Version (FCV). Observes all secondary replication traffic
 * and filters down to relevant entries for FCV.
 */
class FcvOpObserver : public OpObserverNoop {
