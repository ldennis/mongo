    ...
    auto future = std::move(present).then([this, checkoutSession, anchor] {
        ...
        return makeReadyFutureWith([] {})
            .then([this, anchor] {
                ...
                tenant_migration_access::checkIfCanReadOrBlock(
            ...
            .onError<ErrorCodes::TenantMigrationConflict>([this, anchor](Status status) {
                tenant_migration_access::handleTenantMigrationConflict(
...
Future<bool> RunCommandImpl::_epilogue() {
    ...
    tenant_migration_access::checkIfLinearizableReadWasAllowedOrThrow(opCtx, request.getDatabase());
